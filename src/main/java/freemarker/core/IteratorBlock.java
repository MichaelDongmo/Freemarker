...
//                              hasNext = iterModel.hasNext();								
                                ...
                                hasNext = iterModel.hasNext();
// hasNext() e' stato spostato perche' i DBDataSet non sono compatibili con questo tipo di uso: hasNext() se
// eseguita subito dopo una next() sposta in avanti il dataset! 
